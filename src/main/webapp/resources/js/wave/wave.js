...
// 	pointStyle: null,
    ...
    widthbox.addEventListener("click", function(e) {
    	var pos = wave.getPos(e).pos;
    	var offset = wave.getPos(e).offset;
    	if(playBar != null) {
    		wave.removebar(playBar);
    	}
    	playBar = wave.addbar(pos, 'blue', offset);
    }, false);
 ...
 */
Wave.prototype.addbar = function(pos, col, offset) {
...
Wave.prototype.getbar = function() {
	return playBar;
}
